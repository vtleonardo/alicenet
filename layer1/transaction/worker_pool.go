...
// WorkerPool is a Struct that keep track of the state needed by the worker pool service. The
...
// ExecuteWork function to spawn the workers and wait for the job to be done.
