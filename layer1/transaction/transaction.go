...
// FrontWatcher is a struct that has the data necessary by the Transaction service. The
...
// Wait function that wait for a transaction receipt. This is blocking function that
...
// SubscribeAndWait queue a transaction and wait for its receipt
