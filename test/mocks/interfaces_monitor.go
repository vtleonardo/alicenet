...
func NewMockDepositHandler() *MockDepositHandler {
	return &MockDepositHandler{
		AddFunc: &DepositHandlerAddFunc{
			defaultHook: func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) (r0 error) {
				return
			},
		},
	}
...
func NewStrictMockDepositHandler() *MockDepositHandler {
	return &MockDepositHandler{
		AddFunc: &DepositHandlerAddFunc{
			defaultHook: func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error {
...
type DepositHandlerAddFunc struct {
	defaultHook func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error
	hooks       []func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error
...
func (m *MockDepositHandler) Add(v0 *v2.Txn, v1 uint32, v2 []byte, v3 *big.Int, v4 *appObjs.Owner) error {
...
// empty.
func (f *DepositHandlerAddFunc) SetDefaultHook(hook func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error) {
	f.defaultHook = hook
}
...
func (f *DepositHandlerAddFunc) PushHook(hook func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *DepositHandlerAddFunc) SetDefaultReturn(r0 error) {
	f.SetDefaultHook(func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error {
		return r0
	})
}
...
func (f *DepositHandlerAddFunc) PushReturn(r0 error) {
	f.PushHook(func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error {
		return r0
	})
}

func (f *DepositHandlerAddFunc) nextHook() func(*v2.Txn, uint32, []byte, *big.Int, *appObjs.Owner) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
